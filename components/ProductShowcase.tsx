...
const ProductShowcase: React.FC = () => {
  ...
  const handlePageChange = (page: number) => {
    if (page >= 1 && page <= totalPages) {
      setCurrentPage(page);
      // Có thể thêm scrollTo top ở đây nếu muốn
    }
  };
    ...
    <section id="products" className="py-24 bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-12">
          <div>
            <h2 className="text-3xl font-bold text-white mb-1">Featured Arrivals</h2>
            <p className="text-slate-400 text-sm">Hand-picked best sellers.</p>
          </div>
          <Button variant="ghost" className="text-sm px-3 py-1">View All</Button>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* SỬ DỤNG currentLaptops THAY VÌ LAPTOPS */}
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="space-y-1 mb-4 text-xs text-slate-400">
                    ...
                    <div className="flex justify-between">
                      <span>Screen:</span> <span className="text-slate-200">{laptop.specs.screen}</span>
                    </div>
                  </div>
          ...
          <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="md:w-1/2 relative bg-slate-950">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-slate-900 via-transparent to-transparent md:bg-linear-to-r" />
              </div>
